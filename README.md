...
| **context-guardian** | Keep agent context lean and focused across coding sessions. Covers context audits, research/implementation splits, session drift recovery, and prompt crafting. |
