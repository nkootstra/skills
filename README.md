...
| **create-agents** | Write, audit, and improve AGENTS.md files. Produces minimal, high-signal context that earns its cost on every session. |
| **python-mastery** | Comprehensive Python expertise covering language fundamentals, idiomatic patterns, software design principles, and production best practices. |
